...
Explore
 ...
 Sign out
 Watch 0
  Star 0  Fork 2 gcses/CSOD-JS
 Code  Issues 0  Pull requests 0  Projects 0  Wiki  Insights  Settings
Tree: 6a6b3efe6d Find file Copy pathCSOD-JS/footer_html_pilot_24FEB2017.js
6a6b3ef  11 days ago
@gcses gcses Update footer_html_pilot_24FEB2017.js
2 contributors @gcses @sangeethaganessan
RawBlameHistory      
747 lines (534 sloc)  34.3 KB
//var iScrollPos = 0;
...
$(document).ready(function(){
	...
	$('.topBar').css({'backgroundColor': '#004593',  'margin-top': '0px', 'margin-right': '10px', 'border': '0px solid #004593'});  //yellow border
	...
	if (imgLoc != null)
	{
	    ...
	    $('.topBar').css({'width': '35px', 'margin': '-5px 0px 0px -30px',  'border-radius': '0', 'border-left': '6px ' , 'border-right': '6px', 'padding-left': '10px', 'padding-right': '10px'});
	}
	else
	{
