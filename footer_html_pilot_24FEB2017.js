...
$(document).ready(function() {
	...
	$('.df-footer').css({"margin": "15px 0px 0px 0px", "backgroundColor": "#f2f2f2", "width": "100%", "padding": "0px"});					
	...
	$('.df-footer').each(function(){
	        $(this).html('<img src="https://bd-pilot.csod.com/clientimg/bd/welcome/angle.png" id="slopedFooterImage" />' +
			     ...
			     '<td id="footerTD2"><a href="#"/></td>'+
			     '<td id="footerTD3"><a href="#"/></td>'+
			     '<td id="footerTD4><a href="#"/></td>'+
			     '<td id="footerTD5"><a href="#"/></td>'+
	...
	//footerLogo
	 $('#footerTD1').css({'padding-left': '0px', 'width': '90px'});

	 $('#footerTD2').css({'width': '20px', 'height': '15px', 'background': 'url("https://bd-pilot.csod.com/clientimg/bd/welcome/compass-sprite2.png") no-repeat scroll 0px -255px transparent'});
	 $('#footerTD3').css({'width': '20px', 'height': '15px', 'background': 'url("https://bd-pilot.csod.com/clientimg/bd/welcome/compass-sprite2.png") no-repeat scroll -40px -255px transparent'});
	 $('#footerTD4').css({'width': '20px', 'height': '15px', 'background': 'url("https://bd-pilot.csod.com/clientimg/bd/welcome/compass-sprite2.png") no-repeat scroll -80px -255px transparent'});
	 $('#footerTD5').css({'width': '20px', 'height': '15px', 'background': 'url("https://bd-pilot.csod.com/clientimg/bd/welcome/compass-sprite2.png") no-repeat scroll -120px -255px transparent'});
