...
$(document).ready(function() {
	...
	//footer logo
	 ...
	 //top, right, bottom, left: 50-55,
         $('#footerTD2').css({'padding-top': '0px', 'width': '7px', 'height': '0px', 'margin': '0px 0px 0px 0px',  'background': 'url("https://bd-pilot.csod.com/clientimg/bd/welcome/compass-sprite-4.png") no-repeat scroll 0px -255px transparent'});
	 $('#footerTD3').css({'padding-top': '0px', 'width': '7px', 'height': '0px', 'margin': '0px 0px 0px 0px',  'background': 'url("https://bd-pilot.csod.com/clientimg/bd/welcome/compass-sprite-4.png") no-repeat scroll 0px -255px transparent'});
	 $('#footerTD4').css({'padding-top': '0px', 'width': '7px', 'height': '0px', 'margin': '0px 0px 0px 0px',  'background': 'url("https://bd-pilot.csod.com/clientimg/bd/welcome/compass-sprite-4.png") no-repeat scroll -10px -255px transparent'});
	 $('#footerTD5').css({'padding-top': '0px', 'width': '7px', 'height': '0px', 'margin': '0px 0px 0px 0px',  'background': 'url("https://bd-pilot.csod.com/clientimg/bd/welcome/compass-sprite-4.png") no-repeat scroll -10px -255px transparent'});
