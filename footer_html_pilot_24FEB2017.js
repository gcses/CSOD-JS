(function($) {
	...
	$smjquery(document).ready(function() {
		...
		$smjquery('#search .cso-top-srch-box').css({'backgroundColor': '#004593', 'border-radius': '4px', 'margin-top': '7px', 'margin-left': '-10px', 'margin-right': '10px', 'border': '0px solid #004593' , 'padding-left': '0'});
