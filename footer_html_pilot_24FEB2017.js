...
$(document).ready(function() {
	...
	//footerLogo
	 $('#footerTD1').css({'padding-left': '0px', 'width': '40px'});
         ...
         $('#footerTD2').css({'width': '20px', 'padding': '5px', 'backgroundColor': 'red', 'background': 'url("https://bd-pilot.csod.com/clientimg/bd/welcome/compass-sprite4.png") no-repeat scroll 0px -255px transparent'});
	 $('#footerTD3').css({'width': '20px', 'padding': '5px', 'backgroundColor': 'blue', 'background': 'url("https://bd-pilot.csod.com/clientimg/bd/welcome/compass-sprite4.png") no-repeat scroll -40px -255px transparent'});
	 $('#footerTD4').css({'width': '20px', 'padding': '5px', 'backgroundColor': 'red', 'background': 'url("https://bd-pilot.csod.com/clientimg/bd/welcome/compass-sprite4.png") no-repeat scroll -80px -255px transparent'});
	 $('#footerTD5').css({'width': '20px', 'padding': '5px', 'backgroundColor': 'blue', 'background': 'url("https://bd-pilot.csod.com/clientimg/bd/welcome/compass-sprite4.png") no-repeat scroll -120px -255px transparent'});
