...
$(document).ready(function() {
	...
	$('#header_headerFixed_hlAvatar').css({'backgroundColor': '#004593',  'margin-top': '0px', 'margin-left': '0px', 'border': '0px solid #004593'});  //yellow border
	$('.avatar').css({'backgroundColor': '#004593', 'border-radius': '0', 'margin-top': '0px', 'margin-left': '0px', 'border': '0px solid #004593'});
	$('.avatar a .img').css({'backgroundColor': '#004593', 'border-radius': '0', 'margin-top': '0px', 'margin-left': '0px', 'border': '0px solid #004593'});
	$('.avatar a').css({'backgroundColor': '#004593', 'border-radius': '0',  'margin-top': '0px', 'margin-left': '0px', 'border': '0px solid #004593'});
