...
$(document).ready(function() {
	...
	//footer logo
	 ...
	 //top, right, bottom, left
         $('#footerTD2').css({'padding-top': '0px', 'width': '0px', 'height': '0px', 'margin': '0px 0px 0px 5px',  'background': 'url("https://bd-pilot.csod.com/clientimg/bd/welcome/compass-sprite-4.png") no-repeat scroll 20px -255px transparent'});
	 $('#footerTD3').css({'padding-top': '0px', 'width': '0px', 'height': '0px', 'margin': '0px 0px 0px 5px',  'background': 'url("https://bd-pilot.csod.com/clientimg/bd/welcome/compass-sprite-4.png") no-repeat scroll 20px -255px transparent'});
	 $('#footerTD4').css({'padding-top': '0px', 'width': '0px', 'height': '0px', 'margin': '0px 0px 0px 5px',  'background': 'url("https://bd-pilot.csod.com/clientimg/bd/welcome/compass-sprite-4.png") no-repeat scroll 20px -255px transparent'});
	 $('#footerTD5').css({'padding-top': '0px', 'width': '0px', 'height': '0px', 'margin': '0px 0px 0px 5px',  'background': 'url("https://bd-pilot.csod.com/clientimg/bd/welcome/compass-sprite-4.png") no-repeat scroll 20px -255px transparent'});
