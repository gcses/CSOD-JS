$(document).ready(function(){
	...
	if (document.title.indexOf("Welcome - Realize Your Potential") > -1)
	{
	    ...
	    $("#sliderButton").css({"font-weight": "bold", "padding": "12px", "width": "90px", "height": "15px", "color": "#ffffff", "appearance": "button", "text-decoration": "none", "backgroundColor": "#004593", "margin": "70px 0px 0px 40%"}); 
