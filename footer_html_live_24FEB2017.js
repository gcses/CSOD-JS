$(document).ready(function(){
	...
	{
	    $("#sliderButton").css({"padding": "10px", "width": "150px", "height": "40px", "color": "#ffffff", "appearance": "button", "text-decoration": "none", "backgroundColor": "#004593", "margin": "50px 0px 0px 50px"}); 
